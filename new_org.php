...
if (isset($_POST['regreg'])) 
{
		...
		$email=trim($email); 
		$pword=trim($pword);
	if($uname==''||$email==''||$country==''||$name==''||$pword==''||$orgdesc==''||$name_org=='')
	{?>
	<p align="center"><font face="Verdana" size = "4" color="#376FA6"><br><br>
	All fields are required! Please go back and complete your information...
	</font><p>
	<?}
	else
	{
	$result = mysql_query("SELECT * FROM orgs WHERE uname='$uname' OR email = '$email' ");
	$num=mysql_num_rows($result);
	if($num!=0)
	{?>
	<p align="center"><font face="Verdana" size = "4" color="#376FA6"><br><br>
	Record with username <? echo $uname; ?> and/or email <? echo $email; ?> already exits. 	<br><br>If you are a new user, go back to choose another username or check your e-mail address. 	<br><br>If you are already registered as an organisation, Sign In with your username or email and your password.
	</font><p>
	<?}
	else{
	$result = mysql_query("SELECT * FROM orgs WHERE email='$email' ");
	$num=mysql_num_rows($result);
	if($num!=0)
	{?>
	<p align="center"><font face="Verdana" size = "4" color="#376FA6"><br><br>
	Record with email <? echo $email; ?> already exists. If you are already registered as an organisation, Sign In with your username and password. 
	</font><p>
	<?}
	else { 

   $insert_command = "INSERT INTO orgs(name, country, email, uname, pword, orgdesc, name_org) VALUES('$name', '$country', '$email', '$uname', '$pword', '$orgdesc', '$name_org')";
   $sent = mysql_query($insert_command, $connect);


      if($sent) {  $id = mysql_insert_id(); $_SESSION['id']=$id; $_SESSION['back']=''; echo '<p align="center"><font face="Verdana" size = "4" color="#376FA6"><br><br>
	Thank you for your application. <br><br>Your details below have been sent to the IOF RYDC with application ID <b>'.$id.'</b> for approval. <br><br>Once approved, you will receive an e-mail of notification, after which you may sign in and use the platform.
	</font></p>
<table align="center" width="50%" bordercolor="#376FA6">

<tr><td colspan="2"><font face="Verdana" color="#376FA6" size="2"><u>Organisation Details</u></font></td></tr>
<tr><td><font face="Verdana" color="#376FA6" size="2">Name </font></td><td><font face="Verdana" color="#376FA6" size="2">: '.$name_org.' </td></tr>

<tr><td><font face="Verdana" color="#376FA6" size="2">Country</font></td><td><font face="Verdana" color="#376FA6" size="2">: '.$country.'</td></tr>

<tr><td><font face="Verdana" color="#376FA6" size="2">Description</font></td><td valign = "top"><table><tr><td valign = "top"><font face="Verdana" color="#376FA6" size="2">: '.$orgdesc.'</td></tr></table></td></tr>

<tr><td colspan="2"><font face="Verdana" color="#376FA6" size="2"><br><u>Person authorized to use the platform</u></font></td></tr>
<tr><td><font face="Verdana" color="#376FA6" size="2">Name</font></td><td><font face="Verdana" color="#376FA6" size="2">: '.$name.'</td></tr>

<tr><td><font face="Verdana" color="#376FA6" size="2">E-mail</font></td><td><font face="Verdana" color="#376FA6" size="2">: '.$email.'</td></tr>
...
$to = "nerminfenmen@gmail.com"; // "susi_rutz@hotmail.com, susen.loesch93@gmx.de";
$subject = "[GOVP] Approve Organisation";

$message = " A new organisation with ID <? echo $id; ?> has applied to use GOVP and is waiting for your approval. Check the details here..."

// More headers
// $headers = "From: fenmen@bilkent.edu.tr" . "\r\n";
...
<form method="POST" action="new_org.php">
<table width="300" bordercolor="#376FA6">

<tr><td colspan="2"><p align="center"><font face="Verdana" color="#376FA6" size="2"><b>Register as an organisation</b><br><font face="Verdana" color="#FF0000" size="1">Please note that your registration will be sent for approval by the IOF-RYDC before you are allowed to use the platform!</font></p></td></tr>

<tr><td colspan="2"><p align="center"><font face="Verdana" color="#FF0000" size="1"><b>All fields are required!</b></p></td></tr>
<tr><td><font face="Verdana" color="#376FA6" size="2">Name of org.</font><font face="Verdana" color="#FF0000" size="1">*</font></td><td>: <input type="text" name="name_org" size="20"></td></tr>

<tr><td><font face="Verdana" color="#376FA6" size="2">Country</font><font face="Verdana" color="#FF0000" size="1">*</font></td><td>: <input type="text" name="country" size="20"></td></tr>

<tr><td colspan="2"><p align="center"><font face="Verdana" color="#376FA6" size="2">Short description of the organisation</font><font face="Verdana" color="#FF0000" size="1">*</font><br><font face="Verdana" color="#FF0000" size="1">If this is a member Federation of the IOF, just put "Federation" as description</font><br><textarea rows="4" cols="35" name="orgdesc" value=''></textarea> </p></td></tr>

<tr><td colspan="2" align="center"><font face="Verdana" color="#376FA6" size="2"><u>Person authorized to use the platform</u></font><font face="Verdana" color="#FF0000" size="1">*</font></td></tr>
...
<tr><td><font face="Verdana" color="#376FA6" size="2">Username</font><font face="Verdana" color="#FF0000" size="1">*</font></td><td>: <input type="text" name="uname" size="20"></td></tr>
<tr><td><font face="Verdana" color="#376FA6" size="2">Password</font><font face="Verdana" color="#FF0000" size="1">*</font></td><td>: <input type="password" name="pword" size="20"></td></tr>


<tr><td colspan="2"><p align="center"><input type="submit" value="Submit for approval!" name="regreg"></p></td>
...
<font size="3" face="Verdana"><b>Welcome to the Global Orienteering Volunteer Platform!<br>
	<br>Register to use the platform...</b>  </td></tr></table>
